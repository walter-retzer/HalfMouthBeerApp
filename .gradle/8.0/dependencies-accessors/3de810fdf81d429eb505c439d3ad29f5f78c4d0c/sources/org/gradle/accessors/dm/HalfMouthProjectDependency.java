...
@NonNullApi
public class HalfMouthProjectDependency extends DelegatingProjectDependency {

    @Inject
    public HalfMouthProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
